...
int main()
{
    ...
    distancia = sqrt(pow(dois_pontos[0].x-dois_pontos[1].x, 2)+pow(dois_pontos[0].y-dois_pontos[1].y, 2));

    printf("Distancia entre (%.1f, %.1f) e (%.1f, %.1f) eh %.2f.\n", dois_pontos[0].x, dois_pontos[0].y, dois_pontos[1].x, dois_pontos[1].y, distancia);
    return 0;
}//Fim da funcao main()
