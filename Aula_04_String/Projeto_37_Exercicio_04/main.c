...
int main() {
  ...
  for (int i = 0; i < tam; i++) {
    if (string_01[i] == 'a' || string_01[i] == 'A') cont[0]++;
    if (string_01[i] == 'e' || string_01[i] == 'E') cont[1]++;
    if (string_01[i] == 'i' || string_01[i] == 'I') cont[2]++;
    if (string_01[i] == 'o' || string_01[i] == 'O') cont[3]++;
    if (string_01[i] == 'u' || string_01[i] == 'U') cont[4]++;
  }  // Fim do for
  // Imprime resultado
  printf("Letras 'a's: %d\n", cont[0]);
  printf("Letras 'e's: %d\n", cont[1]);
